...
const ListProduct = ({ products, loading }) => {
    ...
    const currentProducts = products.slice(indexOfFirstProduct, indexOfLastProduct); // starts from indexOfFirstProduct and ends on indexOfLastProduct suppose slice(9, 18) to 9 se shuru kr k 18 tak products extract krlega
                        ...
                        >
                            {currentProducts.map((product, key) => (
                                ...
                                >
                                    ...
                                    <div className="w-[70%] flex flex-col gap-2 h-full justify-center py-3">
