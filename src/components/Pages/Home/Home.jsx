            ...
            <div className="relative w-full h-[100vh] mb-[70px]">
                <Slider {...settings} className="h-full">
                    ...
                    <div className="relative w-full h-screen">
                        <img src="/images/icons/banner4.jpg" alt="banner1" className="w-full h-full object-cover" />
                    ...
                    {/* Slide 2 */}
                    <div className="relative w-full h-screen">
                        <img src="/images/icons/banner2.jpg" alt="Elegant Interior" className="w-full h-full object-cover" />
                        <div className="absolute inset-0 bg-black/50"></div>
                    ...
                    {/* Slide 3 */}
                    <div className="relative w-full h-screen">
                        <img src="/images/icons/banner3.jpg" alt="Dream House" className="w-full h-full object-cover" />
                        <div className="absolute inset-0 bg-black/50"></div>
